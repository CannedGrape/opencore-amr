...
/* ./.libs/lt-amrnb-dec.c - temporary wrapper executable for .libs/amrnb-dec.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1

   The amrnb-dec program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "amrnb-dec.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# amrnb-dec - temporary wrapper script for .libs/amrnb-dec.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1\n", f);
  fputs ("#\n", f);
  fputs ("# The amrnb-dec program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"amrnb-dec.exe:amrnb-dec:${LINENO}: libtool wrapper (GNU libtool) 2.4.", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"amrnb-dec.exe:amrnb-dec:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"amrnb-dec.exe:amrnb-dec:${LINENO}: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
