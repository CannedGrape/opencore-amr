...
const char * EXE_PATH_VALUE   = "D:\\HOME\\AMR_Codec\\opencore-amr-0.1.3\\amrnb\\.libs;C:\\msys64\\mingw64\\lib;C:\\msys64\\mingw64\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    PATH=/d/HOME/AMR_Codec/opencore-amr-0.1.3/amrnb/.libs:/mingw64/lib:/mingw64", f);
  fputs ("/bin:$PATH\n", f);
  fputs ("\n", f);
