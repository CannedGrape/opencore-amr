...
/* ./.libs/lt-amrnb-enc-sine.c - temporary wrapper executable for .libs/amrnb-enc-sine.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1

   The amrnb-enc-sine program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "D:\\HOME\\AMR_Codec\\opencore-amr-0.1.3\\amrnb\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\HOME\\AMR_Codec\\opencore-amr-0.1.3\\amrnb\\.libs;C:\\msys32\\usr\\local\\lib;C:\\msys32\\usr\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "amrnb-enc-sine.exe"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.2 Debian-2.4.2-1\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# amrnb-enc-sine - temporary wrapper script for .libs/amrnb-enc-sine.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1\n", f);
  fputs ("#\n", f);
  fputs ("# The amrnb-enc-sine program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../amrnb/libopencore-amrnb.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"amrnb-enc-sine.exe:amrnb-enc-sine:${LINENO}: libtool wrapper (GNU lib", f);
  fputs ("tool) 2.4.2 Debian-2.4.2-1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"amrnb-enc-sine.exe:amrnb-enc-sine:${LINENO}: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"amrnb-enc-sine.exe:amrnb-enc-sine:${LINENO}: newargv[0]: $progdi", f);
  fputs ("r/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='amrnb-enc-sine.exe'\n", f);
  ...
  fputs ("    PATH=/d/HOME/AMR_Codec/opencore-amr-0.1.3/amrnb/.libs:/usr/local/lib:/usr/l", f);
  fputs ("ocal/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/HOME/AMR_Codec/opencore-amr-0.1.3/amrnb/.libs:$PATH\"\n", f);
  fputs ("\n", f);
