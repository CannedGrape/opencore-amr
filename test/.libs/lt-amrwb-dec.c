...
/* ./.libs/lt-amrwb-dec.c - temporary wrapper executable for .libs/amrwb-dec.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1

   The amrwb-dec program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "D:\\HOME\\AMR_Codec\\opencore-amr-0.1.3\\amrwb\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\HOME\\AMR_Codec\\opencore-amr-0.1.3\\amrwb\\.libs;C:\\msys32\\usr\\local\\lib;C:\\msys32\\usr\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "amrwb-dec.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# amrwb-dec - temporary wrapper script for .libs/amrwb-dec.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1\n", f);
  fputs ("#\n", f);
  fputs ("# The amrwb-dec program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../amrwb/libopencore-amrwb.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"amrwb-dec.exe:amrwb-dec:${LINENO}: libtool wrapper (GNU libtool) 2.4.", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"amrwb-dec.exe:amrwb-dec:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"amrwb-dec.exe:amrwb-dec:${LINENO}: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
  ...
  fputs ("    PATH=/d/HOME/AMR_Codec/opencore-amr-0.1.3/amrwb/.libs:/usr/local/lib:/usr/l", f);
  fputs ("ocal/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/HOME/AMR_Codec/opencore-amr-0.1.3/amrwb/.libs:$PATH\"\n", f);
  fputs ("\n", f);
